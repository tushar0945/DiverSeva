    ...
    <nav className="w-full bg-white shadow-sm">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between h-20">
          {/* Logo */}
          <div className="flex items-center gap-1 text-2xl font-extrabold cursor-pointer">
          ...
          {/* CTA Button */}
          <button className="px-7 py-3 rounded-md text-white font-semibold bg-gradient-to-r from-emerald-600 to-emerald-500 hover:opacity-90 transition">
            Book Now
          </button>
        </div>
      </div>
